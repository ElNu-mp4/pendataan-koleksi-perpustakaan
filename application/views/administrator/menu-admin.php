          ...
          <ul class="sidebar-menu">
            ...
            <li class="treeview">
              ...
              <?php
                ...
                // PENDATAAN KOLEKSI PERPUSTAKAAN - NEW MODULE
                $cek=$this->model_app->umenu_akses("pendataan",$this->session->id_session);
                if($cek==1 OR $this->session->level=='admin'){
                  echo "<li><a href='".base_url()."administrator/pendataan'><i class='fa fa-circle-o'></i> Pendataan Koleksi</a></li>";
                }
              ?>
              </ul>
            </li>
